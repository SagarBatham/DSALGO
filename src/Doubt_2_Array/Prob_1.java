...
// money and she wants to spend all of her money. However, she can only purchase one kind of item. 
// She goes to a shop which has ‘n’ types items with prices A0,A1,A2,…,An-1. The shopkeeper claims that 
// he has at least ‘k’ items she can choose from. Help her find out if the shopkeeper is correct or not.


// Input Format
// The first line contains an integer ‘n’ denoting the number of items in the shop. T
// he second line contains ‘n’ space-separated integers describing the respective price of each item. 
